...
export enum CommandType {
    ...
    CMD_INDOOR_ENABLE_PRIVACY_MODE_S350_C220 = 6250,
...
export enum SmartSafeCommandCode {
    BIND_CMD = 1,
    VERIFY_IDENTITY,
    DEFAULT,
    ACTIVATE_DEVICE,
    ADD_PASSWORD,
    QUERY_IS_SET_PASSWORD,
    ADD_FINGERPRINT,
    DELETE_FINGERPRINT,
    ...
    QUERY_CRACK_PROTECT,
    QUERY_LOCK_ALARM,
    QUERY_SCRAMBLE_PASSWORD,
    SET_SCRAMBLE_PASSWORD,
    QUERY_DUAL_UNLOCK,
    SET_DUAL_UNLOCK,
    UNLOCK_EVENTS,
    CANCEL_FINGERPRINT,
...
export enum SmartSafeShakeAlarmEvent {
    CANCEL_ALARM = 0,
    ALARM = 1,
}

export enum SmartSafeBatteryTemperatureEvent {
    NORMAL = 0,
    LOW = 1,
    HIGH = 2,
}
